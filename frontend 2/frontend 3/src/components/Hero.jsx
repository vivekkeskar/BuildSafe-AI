    ...
    <section className="mx-auto flex min-h-[80vh] max-w-7xl flex-col items-center justify-between gap-16 px-6 py-20 md:flex-row">
      ...
      >
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button className="rounded-xl bg-orange-500 px-8 py-4 font-semibold text-white transition hover:bg-orange-600 hover:scale-105">
            Upload Image
          </button>

          <button className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-8 py-4 text-white backdrop-blur-lg transition hover:bg-white/10">
            Live Demo
            <FaArrowRight />
          </button>
        </div>
